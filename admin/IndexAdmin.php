	...
	<div class="page-admin">
		...
		<?php
			...
			<div class="content-user">
				...
				<?php
				$sql_select_sp = mysqli_query($conn,$query); 
				?> 
				<table class="table table-bordered ">
					...
					?> 
					<tr>
						<td><?php echo $row_sp['MaSach'] ?></td>
						<td><?php echo $row_sp['TenSach'] ?></td>
                        <td><?php echo $row_sp['DanhMuc'] ?></td>
                        <td><?php echo $row_sp['MoTa'] ?></td>
						<td><img src="../img/<?php echo $row_sp['HinhAnh'] ?>" height="100" width="80"></td>
						<td><?php echo number_format($row_sp['DonGia']).'vnđ' ?></td>
                        <td>
                            <a href="ProductUpdate.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['MaSach'] ?>" class="btn-ED-add">
                                <button class="btn btn-warning">Edit</button>
                            </a>
                            <a href="?xoa=<?php echo $row_sp['MaSach'] ?>" class="btn-ED-add">
