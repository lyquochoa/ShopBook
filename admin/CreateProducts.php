                ...
                <div class="user-table" style="width: 100%;">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="from_row">
                            ...
                            <input type="text" class="from__input" name="tensanpham" placeholder="Tên sản phẩm" style = "width: 300px;" size = "38">
                        </div>
                        <div class="from_row">
                            <label class="input__label" style="margin-right: 50px;">Danh mục</label>
                            <input type="text" class="from__input" name="danhmuc" placeholder="Danh mục" style = "width: 300px;" size = "38">
                        </div>
                        <div class="from_row">
                            <label class="input__label" style="margin-right: 50px;">Giá</label>
                            <input type="text" class="from__input" name="giasanpham" placeholder="Giá sản phẩm" style = "width: 300px;" size = "38">
                        </div>
                        <div class="from_row">
                        ...
                        <div class="from_row">
                            ...
                            <textarea class="from__input" rows="10" name="mota" placeholder="Điền mô tả cần thiết" style = "width: 300px;" size = "38"></textarea>
                        </div>
                        <div class="from_row">                 
