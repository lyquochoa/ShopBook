    ...
    <div id="main">
        ...
        <div class="page-admin">
            ...
            <div class="content-user">
                <div class="admin-title-account" style="font-size: 18px; padding: 0;">Xem đơn hàng</div>
                <div class="user-table" style="width: 100%;">
                    <table>
                        ...
                        <?php
                                $ten=$_SESSION['user']['user_name'];
                                
                            // Chức năng phân trang
                            $item_per_page = !empty($_GET['per_page'])?$_GET['per_page']:5;
                            $current_page = !empty($_GET['page'])?$_GET['page']:1;
                            $offset = ($current_page - 1) * $item_per_page;
                            $query = "SELECT * FROM donhang where TenKH='$ten' ORDER BY MaDH ASC LIMIT  ".$item_per_page." OFFSET ".$offset;
                        ...
                        <tbody>
                            <tr class="order-rows">
                                <td style="text-align: center;"><a href="OrderDetails.php?MaDH=<?php echo $row['MaDH'] ?>"><?php echo $row['MaDH'] ?></a></td>
