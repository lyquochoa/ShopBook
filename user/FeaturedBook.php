                         ...
                         <nav class="category">
                             ...
                             <ul class="category-list">
                                 ...
                                 <li class="category-item category-item--active">
                                     <a href="featured.php" class="category-item__link">Sản phẩm nổi bật</a>
                                 </li>
                             </ul>
                         </nav>
                     </div>
                         ...
                         <div class="home-product">
                             <div class="grid__row">
                                        <?php
                                            ...
                                            $query = "SELECT * FROM sach WHERE DanhMuc = 'Nổi bật' ORDER BY MaSach ASC LIMIT ".$item_per_page." OFFSET ".$offset;
